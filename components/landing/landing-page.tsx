...
function Badge({ icon, text }: { icon: React.ReactNode; text: string }) {
    return (
        <div className="flex items-center gap-2 px-3.5 py-1.5 bg-white/40 backdrop-blur-sm border border-white/60 shadow-sm rounded-full cursor-default select-none animate-in fade-in slide-in-from-top-2 duration-700">
            <div className="text-[#5C7CFA]">{icon}</div>
            <span className="text-[11px] font-bold tracking-[0.05em] uppercase text-slate-600 font-sans">
                {text}
            </span>
        </div>
    )
        ...
        >
            {isActive && (
                <div className="absolute top-0 left-0 w-full h-1 bg-[#5C7CFA]/10">
                    <div
                        className="h-full bg-gradient-to-r from-[#5C7CFA] to-[#8ED1B2] transition-all duration-100 linear"
        ...
        switch (activeCard) {
                ...
                return (
                    <div className="w-full h-full p-10 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-200">
                        <div className="flex items-center gap-5 mb-12">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-slate-800">Growth Velocity</h3>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {[
                                ...
                                { label: "Standing Height", val: "68.2cm", sub: "+2.1cm this month", color: "text-teal-600", bg: "bg-teal-50/30" },
                                { label: "Deep Sleep", val: "12.4h", sub: "15% increase", color: "text-indigo-600", bg: "bg-indigo-50/30" },
            ...
            case 1:
                return (
                    <div className="w-full h-full p-10 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-200">
                        <div className="flex items-center gap-5 mb-12">
                            <div className="w-14 h-14 rounded-2xl bg-teal-50/80 flex items-center justify-center text-[#8ED1B2] shadow-sm">
                                <Syringe size={28} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold text-slate-800">Protection Ledger</h3>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className={`p-6 rounded-[28px] flex items-center justify-between border ${item.done ? "bg-white/80 border-[#8ED1B2]/40 shadow-sm" : "bg-white/40 border-slate-100"}`}>
                                    <div className="flex items-center gap-5">
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${item.done ? "bg-[#8ED1B2] text-white shadow-lg shadow-[#8ED1B2]/20" : "bg-slate-100 text-slate-400"}`}>
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-[11px] font-bold uppercase tracking-wider ${item.done ? "text-[#8ED1B2]" : "text-slate-400"}`}>{item.status}</p>
                                        </div>
                                    </div>
                ...
                return (
                    <div className="w-full h-full p-10 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-200">
                        <div className="flex items-center gap-5 mb-12">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-slate-800">Nutrition Concierge</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4 flex-row-reverse">
                                <div className="w-10 h-10 rounded-full bg-[#8ED1B2] flex items-center justify-center text-white shadow-lg shadow-[#8ED1B2]/20"><Baby size={20} /></div>
                                <div className="bg-white py-4 px-6 rounded-[24px] rounded-tr-sm border border-[#8ED1B2]/20 text-sm font-bold text-slate-800 leading-relaxed max-w-[80%] shadow-lg shadow-[#8ED1B2]/5">
    ...
    return (
        <div className="w-full min-h-screen font-sans selection:bg-[#5C7CFA]/10 selection:text-[#5C7CFA] bg-[#fbfdff]">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
                ...
                <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] bg-[#8ED1B2]/5 rounded-full blur-[140px]" />
            </div>

            <div className="relative z-10 flex flex-col items-center">

                {/* --- Unified Navigation --- */}
                <header className="w-full max-w-[1200px] px-6 mt-6 fixed top-0 z-[100]">
                    <nav className={`w-full mx-auto h-16 px-8 bg-white/80 backdrop-blur-2xl rounded-full border border-white/60 shadow-[0_8px_40px_rgba(0,0,0,0.02)] flex items-center justify-between transition-all duration-300 ${scrolled ? 'shadow-[0_12px_48px_rgba(92,124,250,0.08)] border-[#5C7CFA]/10' : ''}`}>
                        <div className="flex items-center gap-12">
                            ...
                            <div className="hidden lg:flex items-center gap-12">
                                {["Features", "Doctors", "Safety"].map((item) => (
                                    <a key={item} href={`#${item.toLowerCase()}`} className="text-[13px] font-bold text-slate-500 hover:text-slate-900 transition-colors uppercase tracking-[0.2em]">
                                        {item}
                                    </a>
                                ))}
                            </div>
                        ...
                        <div className="flex items-center gap-8">
                            <Link href="/OnBoarding" className="hidden sm:block text-[13px] font-bold text-slate-600 hover:text-slate-900 transition-colors uppercase tracking-[0.1em]">
                                Log in
                            </Link>
                            <Link href="/OnBoarding" className="px-7 h-11 bg-[#5C7CFA] hover:bg-[#4A6CF7] text-white text-[13px] font-bold rounded-full shadow-xl shadow-[#5C7CFA]/20 transition-all hover:-translate-y-0.5 active:scale-95 uppercase tracking-[0.1em] flex items-center justify-center">
                                Get Started
                            </Link>
                        </div>
                    </nav>
                ...
                {/* --- Hero Section --- */}
                <section className="w-full pt-32 sm:pt-40 pb-20 px-6 max-w-[1240px] flex flex-col items-center text-center">

                    <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
                        <Badge icon={<Heart size={14} fill="currentColor" />} text="The motherhood OS" />
                    </div>

                    <div className="max-w-[1000px] space-y-6">
                        <h1 className="text-slate-900 text-[36px] sm:text-[54px] md:text-[72px] lg:text-[84px] font-bold leading-[1.1] tracking-tight animate-in fade-in slide-in-from-bottom-8 duration-1000">
                            <span className="font-sans">A calm perspective on</span>
                            <br />
                            <span className="relative inline-block px-4 pb-2 bg-gradient-to-r from-[#5C7CFA] via-[#8ED1B2] to-[#5C7CFA] bg-[length:200%_auto] animate-gradient bg-clip-text text-transparent italic font-serif font-normal">
                                Motherhood
                            </span>
                        </h1>
                ...
                <section id="features" className="w-full max-w-[1200px] px-6 py-40">
                    <div className="flex flex-col items-center text-center mb-24">
                        <Badge icon={<Star size={14} />} text="Comprehensive Care" />
                        <h2 className="text-4xl md:text-6xl font-black text-slate-900 mt-8 leading-[1.1] tracking-tight">
                            <span className="font-sans">Everything you need to</span>
                            <br />
                            <span className="text-[#5C7CFA] italic font-serif font-normal">Protect</span> <span className="font-sans font-black">and</span> <span className="text-[#8ED1B2] italic font-serif font-normal">Nurture</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {[
                            ...
                            { icon: <MessageCircle size={26} />, title: "Secure Chat", text: "24/7 access to specialized nurses and pediatric counselors.", color: "bg-teal-50/50" },
                ...
                <section id="doctors" className="w-full bg-[#0a0c10] py-40 px-6 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#8ED1B2]/10 rounded-full blur-[120px]" />
                    <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-24 items-center relative z-10">
                        <div className="space-y-10">
                            <Badge icon={<Stethoscope size={14} className="text-[#8ED1B2]" />} text="For Medical Professionals" />
                            <h2 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                                <span className="font-sans">Structured care for</span>
                                <br />
                                <span className="text-[#8ED1B2] italic font-serif font-normal">better outcomes</span>
                            </h2>
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {["Remote Monitoring", "Historical Trends", "Secure Portability", "SOS Connectivity"].map(item => (
                                    <div key={item} className="flex items-center gap-4 text-white font-bold tracking-wide">
                                        <div className="w-2.5 h-2.5 rounded-full bg-[#8ED1B2] shadow-[0_0_10px_rgba(142,209,178,0.5)]" />
                                        {item}
                                    </div>
                                ))}
                            </div>
                            <button className="h-16 px-12 bg-[#8ED1B2] text-slate-900 rounded-full font-bold text-base hover:bg-[#7bc0a1] transition-all shadow-xl shadow-[#8ED1B2]/10">
                                Apply as Partner Doctor
                            </button>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-0 bg-[#8ED1B2]/5 blur-[120px] rounded-full" />
                ...
                <footer className="w-full py-32 px-6 max-w-[1200px] border-t border-slate-100 flex flex-col md:flex-row justify-between items-start gap-16">
                    <div className="space-y-8 max-w-[340px]">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-2xl font-bold tracking-tight text-slate-800">Metis</span>
                        </div>
