...
export default function OnBoarding() {
    ...
    return (
        <main className="min-h-screen metis-gradient flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <Link
                href="/"
                className="absolute top-10 left-10 hidden md:flex items-center gap-2 text-slate-500 hover:text-[#5C7CFA] font-bold text-sm transition-colors group z-20"
            >
            ...
            <div className="mt-12 flex items-center gap-2 text-slate-400 opacity-40 font-bold text-lg z-10">
                <Heart size={16} fill="currentColor" />
                Built for every mother
            </div>
