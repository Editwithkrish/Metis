...
export default function DashboardPage() {
    return (
        <div className="min-h-screen metis-gradient flex text-slate-800 font-sans relative overflow-x-hidden">
            ...
            {/* Main Content Area */}
            <div className="flex-1 ml-24 md:ml-32 relative">
                {/* Decorative Blobs */}
                <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-[#C6DFFF]/30 rounded-full blur-[140px] pointer-events-none z-0" />
                <div className="absolute bottom-[10%] right-[-10%] w-[50%] h-[50%] bg-[#DCE6FF]/25 rounded-full blur-[120px] pointer-events-none z-0" />
                <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] bg-[#E8F1FF]/30 rounded-full blur-[100px] pointer-events-none z-0" />

                <main className="flex flex-col p-4 md:p-8 gap-8 relative z-10">
                    {/* Header */}
                    <header className="flex items-center justify-between gap-4">
                        <div className="flex flex-col">
                            <h1 className="text-3xl font-bold tracking-tight text-slate-900/80">
                                Dashboard
                            </h1>
                            <p className="text-slate-500 font-medium">Welcome back, Sarah</p>
                        </div>
                        ...
                        <div className="flex-1 max-w-md mx-4 hidden md:block">
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full h-12 bg-white/40 backdrop-blur-xl border border-white/60 rounded-full pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-slate-400"
                                />
                            </div>
                        </div>

                        <div className="flex items-center gap-4">
                            <button className="p-2.5 rounded-full bg-white/40 backdrop-blur-xl border border-white/60 text-slate-600 hover:bg-white/60 transition-colors relative cursor-pointer">
                                <Bell size={20} />
                                <span className="absolute top-2 right-2 w-2 h-2 bg-red-400 rounded-full border-2 border-white"></span>
                            </button>
                            <div className="flex items-center gap-3 pl-2">
                                <Avatar className="h-10 w-10 border-2 border-white/60 shadow-sm cursor-pointer">
                                    <AvatarImage src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=150" />
                                    <AvatarFallback>S</AvatarFallback>
                                </Avatar>
                                <div className="hidden lg:block text-sm cursor-default">
                                    <p className="font-bold text-slate-900/80 leading-none">Sarah Wilson</p>
                                    <p className="text-slate-500 text-xs mt-1 font-medium">Mom of baby Leo</p>
                                </div>
                            </div>
                        </div>
                    </header>
